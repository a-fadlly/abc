<form class="p-10 bg-white rounded shadow-xl" wire:submit.prevent="updateUser">
    ...
    <div class="mt-2">
        ...
        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" name="name" type="text"
            placeholder="Name" aria-label="Name" wire:model="name">
    </div>
    @error('name')
    ...
    <div class="mt-2">
        ...
        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="username" name="username" type="text"
            placeholder="Username" aria-label="Username" wire:model="username">
    </div>
    @error('username')
        <div class="text-xs w-100 text-red-500 italic mt-2">{{ $message }}</div>
    @enderror
    <div class="mt-2">
        ...
        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="email" name="email" type="text"
            placeholder="Your Email" aria-label="Email" wire:model="email">
    </div>
    @error('email')
        <div class="text-xs w-100 text-red-500 italic mt-2">{{ $message }}</div>
    @enderror
    ...
    <div class="mt-2">
        ...
        <select class="w-full px-5 py-3 text-gray-700 bg-gray-200 rounded" id="role" name="role" type="text"
            wire:model="role">
    ...
    <div class="mt-2">
        ...
        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="reporting_manager"
            name="reporting_manager" type="text" wire:model="reporting_manager">
    </div>
    ...
    <div class="mt-2">
        <label class="block text-sm text-gray-600" for="reporting_manager">Reporting Manager Manager</label>
        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="reporting_manager_manager"
            name="reporting_manager_manager" type="text" wire:model="reporting_manager_manager">
    </div>
    ...
    <div class="mt-2">
        ...
        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="rayon" name="rayon" type="text"
    ...
    <div class="mt-2">
        ...
        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="regional" name="regional" type="text"
